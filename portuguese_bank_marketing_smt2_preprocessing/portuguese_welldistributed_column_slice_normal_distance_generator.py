# Converts nested column-slice normal-distance well-distributedness files
...
#
# Property:
#   normal-distance well-distributedness
#   using (select O i)
#
...
IN_PATTERN = "{m}_normal_distance.smt2"
OUT_PATTERN = "{m}_normal_distance_column_slice.smt2"
...
def emit_normal_distance_property() -> str:
    """Emit normal-distance well-distributedness property using O[i]."""
    return """
; =====================
...
def main():
    for m in M_VALUES:
        ...
        with open(out_file, "w", encoding="utf-8") as f:
            ...
            f.write("\n\n")
            f.write(emit_normal_distance_property())
